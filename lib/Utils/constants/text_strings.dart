class MTextString {
  ...
  static String letstart = "Let's Start";
  static String fullname = "Full name";
  static String emailormobile = "Email or Mobile Number";
  static String confirmpassword = "Confirm Password";
  static String bycontinueyouagree = "by continuing, you agree to";
  ...
  static String howoldareu = "How Old Are You?";
