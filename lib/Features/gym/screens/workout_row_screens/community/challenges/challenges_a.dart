    ...
    return Scaffold(
      body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        FavouritesScreenContainer(
            ...
            .onTap(
                () => MHelperFunctions.navigateTo(context, const ChallegesB()))
            .pOnly(bottom: 20),
        FavouritesScreenContainer(
      ...
      floatingActionButton: FloatingActionButton(
          onPressed: () =>
              MHelperFunctions.navigateTo(context, const WeeklyChallengeA()),
          child: const Icon(Icons.add, color: MColors.darkPurpleColor)),
    );
  }
}
